%Calcula a velocidade das juntas (rad/s) com base nos angulos (posicao em graus) e
%a velocidade do efetuador (3 primeiros valores em mm/s e tres ultimos em rad/s).
%Ambos os argumentos devem ser passados na forma de vetor.
%Exemplo: velocidade_juntas = kr3ij(angulos_juntas,velocidade_efetuador)
%Exemplo: velocidade_juntas = kr3ij([0 -90 90 80 0 0],[100 100 100 1 1 1])
%
...
function vel_juntas = kr3ij(angulos,vel_efetuador)
...
% Multiplica a velocidade no efetuador pela inversa do Jacobiano para obter
% a velocidade das juntas
vel_juntas = Jacobiano \ transpose(vel_efetuador); 

%vel_juntas(1:3) = vel_juntas(1:3)*1000;
